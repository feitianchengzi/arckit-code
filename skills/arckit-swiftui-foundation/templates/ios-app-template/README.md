...
- `{{PROJECT_NAME}}Tests/` - Unit test target directory
...
```
bash .codex/skills/arckit-swiftui-foundation/scripts/create-ios-app.sh --name HelloWorld --bundle-id com.example.HelloWorld --output ios
```
